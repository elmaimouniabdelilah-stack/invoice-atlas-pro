...
const STEPS = [
  {
    n: '١',
    title: 'سجّل وفعّل',
    desc: 'أنشئ حسابك وأدخل كود التفعيل — تجريبي لساعة أو اشتراك شهري/سنوي/مدى الحياة.',
  },
  {
    n: '٢',
    title: 'أنشئ فاتورتك',
    desc: 'اختر القالب، عبّئ بيانات البائع والمشتري والأصناف، وشاهد المعاينة الحية فوراً.',
  },
  {
    n: '٣',
    title: 'صدّر وشارك',
    desc: 'اطبع PDF أو شارك عبر واتساب والبريد مباشرة، واحفظ نسخة في سجل الفواتير.',
  },
];
